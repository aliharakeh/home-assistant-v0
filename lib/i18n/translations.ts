...
export const translations = {
    en: {
        ...
        deleteBillsInRangeDescription:
            'Select a date range to delete all electricity bills within that period.',
        selectDateRange: 'Select Date Range',
        selectDateRangeForDeletion:
            'Choose the start and end dates for the bills you want to delete.',
        startDate: 'Start Date',
        endDate: 'End Date',
        selectDateRangeError: 'Please select both start and end dates.',
        deleteBillsWarning:
            'Warning: This will permanently delete all bills within the selected date range.',
    ...
    ar: {
        ...
        installAppDescription:
            'قم بتثبيت هذا التطبيق على جهازك للوصول السريع حتى عندما تكون غير متصل بالإنترنت.',
        install: 'تثبيت',
        notNow: 'ليس الآن',
        ...
        mainBills: 'فواتير شركة',
        motorBills: 'فواتير موتور',
        ...
        mainBillsTrend: 'اتجاه الفواتير للشركة',
        motorBillsTrend: 'اتجاه فواتير موتور',
        ...
        deleteBillsWarning:
            'تحذير: سيؤدي هذا إلى حذف جميع الفواتير ضمن نطاق التاريخ المحدد بشكل دائم.',
